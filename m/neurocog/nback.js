...
var testing={
    ...
    MF10CR:data.MF10CR,
    MS10CR:data.MS10CR,
    SDF10CR:data.SDF10CR,
    SDS10CR:data.SDS10CR,
    NTCM:data.NTCM,
    NTCN:data.NTCN,
    NTFM:data.NTFM,
    NTFN:data.NTFN,
    ...
    window.localStorage.setItem('user',JSON.stringify(testing));
    var today = new Date();
    ...
    today =dd+'_'+mm+'_'+yyyy+"-"+hour+"_"+minute+"_"+second;
    var outputfile="";
    var nl="\r\n"
    outputfile="NBACK,Start_Time,NGTA,NGRT,GMRT,NTCR,NTIC,NMIS,NMRT,MRTCM,MRTCN,SDCR,SDCM,SDCN,MdRTCR,MdRTCM,MnRTCR,MxRTCR,MF10CR,MS10CR,SDF10CR,SDS10CR,NTCM,NTCN,NTFM,NTFN,NTWR,NNO,NRT,NAC"+nl+testing.nback+","+testing.Start_Time+","+testing.NGTA+","+testing.NGRT+","+testing.GMRT+","+testing.NTCR+","+testing.NTIC+","+testing.NMIS+","+testing.NMRT+","+testing.MRTCM+","+testing.MRTCN+","+testing.SDCR+","+testing.SDCM+","+testing.SDCN+","+testing.MdRTCR+","+testing.MdRTCM+","+testing.MnRTCR+","+testing.MxRTCR+","+testing.MF10CR+","+testing.MS10CR+","+testing.SDF10CR+","+testing.SDS10CR+","+testing.NTCM+","+testing.NTCN+","+testing.NTFM+","+testing.NTFN+","+testing.NTWR+",\""+testing.NNO+"\",\""+testing.NRT+"\",\""+testing.NAC+"\"";
    
    download_txt(testing.nback+"BACK_"+today+".csv",outputfile);
